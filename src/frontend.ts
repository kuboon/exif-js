export async function getArrayBufferFrom(something: HTMLImageElement | HTMLInputElement | URL | string | Blob): Promise<ArrayBuffer> {
  ...
  if(!blob) {
    throw new Error("Invalid argument. Expected HTMLImageElement | HTMLInputElement(type=file) | URL | string | Blob");
  }
